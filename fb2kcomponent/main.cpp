...
DECLARE_COMPONENT_VERSION("SimpleSynth", "1.0.0.0", u8"SimpleSynth - A Simple Modular Synthesizer.\nCopyright © 2024-2025 yzrilyzr.\n\nSimpleSynth for foobar2000 (foo_simplesynth version).\n\nGitee: https://gitee.com/yzrilyzr/libs_cpp\nGithub: https://github.com/yzrilyzr/SimpleSynth");


// This will prevent users from renaming your component around (important for proper troubleshooter behaviors) or loading multiple instances of it.
VALIDATE_COMPONENT_FILENAME("foo_simplesynth.dll");

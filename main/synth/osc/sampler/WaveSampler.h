...
namespace yzrilyzr_simplesynth{
	ECLASS(WaveSampler, public NoteProcessor){
	public:
	...
	public:
	WaveSampler();
	WaveSampler(s_phase phaseMul, u_sp<yzrilyzr_array::SampleProvider> sampleData, u_index sampleOffset, u_index sampleLength,
	...
	*/
	...
	u_sp<WaveSampler> build(){
		return mksp<WaveSampler>(phaseMul, sampleData, sampleOffset, sampleLength,

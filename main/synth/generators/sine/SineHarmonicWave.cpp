...
namespace yzrilyzr_simplesynth{
	...
	SineHarmonicWave::SineHarmonicWave(DoubleArray *freqAndAmp): SineHarmonicWave(nullptr, freqAndAmp){}
	SineHarmonicWave::SineHarmonicWave(std::shared_ptr<PhaseSrc> freq, DoubleArray *freqAndAmp): Osc(freq){
		this->aa=freqAndAmp;
	}
